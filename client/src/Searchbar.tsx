...
function Searchbar() {
    ...
    return (
        <form onSubmit={handleSubmit} onChange={handleChange} action="" method="get" className='w-screen flex flex-col items-center text-cat-macchiato-text'>
            <input type="search" name="" id="squery" placeholder='Search with DuckDuckGo' className='p-2 placeholder-cat-macchiato-text w-1/3 h-10 box-border border-2 border-cat-macchiato-crust rounded-full bg-cat-macchiato-crust bg-opacity-55 hover:scale-105 ease-in-out duration-300' autoComplete="off" />
        </form>
    )
